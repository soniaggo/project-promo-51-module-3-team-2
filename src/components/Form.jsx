...
function Form({ pformData, psetFormData, projectImage, setProjectImage, authorImage, setAuthorImage }) {
  ...
  return (
    <form className="addForm">
      ...
      <input className="addForm__input" type="text" name="technologies" id="technologies" placeholder="Género" value={pformData.technologies} onChange={handleChange} />
      <textarea className="addForm__input" name="desc" id="desc" placeholder="Sinopsis" rows="5" value={pformData.desc} onChange={handleChange}></textarea>
